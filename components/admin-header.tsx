    ...
    <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link href="/admin/dashboard" className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg">SportClub Admin</span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link href="/admin/athletes" className="text-sm font-medium hover:text-primary transition-colors">
            Atletas
          </Link>
          <Link href="/admin/events" className="text-sm font-medium hover:text-primary transition-colors">
            Eventos
          </Link>
          <Link href="/admin/competitions" className="text-sm font-medium hover:text-primary transition-colors">
            Competencias
          </Link>
